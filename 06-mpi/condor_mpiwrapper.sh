...
echo "Running mpirun -verbose -launcher ssh -np $_CONDOR_NPROCS -machinefile machines $EXECUTABLE $@"
mpirun -verbose -launcher ssh -np $_CONDOR_NPROCS -machinefile machines $EXECUTABLE $@ 2>&1
